...
start() {
	...
	colorEcho $GREEN "打开后台请输入 推送地址，获取配置信息。推送地址在中转服务器设置中查看kenc推送地址"
	colorEcho $GREEN "不会使用请加QQ群:893145602 获取最新教程"
        colorEcho $GREEN "|-----------------------------------------------------------------------------|"
	colorEcho $GREEN "|致力于打造性能强大, 功能齐全, 9000台无压力不崩溃，BTC ETC ETH LTC等全币种无损抽水|"
    fi
}
...
colorEcho ${GREEN} "-----------------------------------------"
colorEcho ${GREEN} "请注意 此处安装是局域网安装，需要配合中转"
colorEcho $GREEN "不会使用请加QQ群:893145602 获取最新教程"
